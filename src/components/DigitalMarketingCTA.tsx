  ...
  return (
    <section className="mt-12 p-8 rounded-2xl bg-muted/50 border border-border">
      ...
      <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <Link to="/email-marketing" className="text-muted-foreground hover:text-foreground transition-colors">
          email marketing Sri Lanka
        </Link>
        ,{" "}
        <Link to="/sms-marketing" className="text-muted-foreground hover:text-foreground transition-colors">
          SMS marketing Sri Lanka
        </Link>
        , and{" "}
        <Link to="/whatsapp-marketing" className="text-muted-foreground hover:text-foreground transition-colors">
