    ...
    >
      ...
      <IndustryMarketingSection
        ...
        industries={[
          ...
          { emoji: "🛍️", title: "E-commerce Email Marketing Sri Lanka – Drive Instant Sales", campaigns: ["Flash sales & limited-time discounts", "Product launches & exclusive offers", "Seasonal campaigns (New Year, festive promotions)"], results: ["Immediate website traffic", "Increased online sales", "Higher customer retention"], link: null, linkText: "" },
          { emoji: "🍽️", title: "Restaurant Email Marketing Sri Lanka – Increase Daily Customers", campaigns: ["Lunch & dinner deals", "Event promotions (live music, special nights)", "Discount coupons & loyalty campaigns"], results: ["Increased foot traffic", "More repeat customers", "Stronger brand recall"], link: null, linkText: "" },
          { emoji: "💼", title: "Recruitment Email Marketing Sri Lanka – Find the Right Talent Faster", campaigns: ["Job vacancy promotions", "Industry-specific hiring campaigns", "Bulk recruitment drives"], results: ["Faster hiring cycles", "More qualified applicants", "Reduced recruitment costs"], link: null, linkText: "" },
          ...
          { emoji: "🏦", title: "Finance Email Marketing Sri Lanka – Generate High-Value Leads", campaigns: ["Loan, leasing & credit card offers", "Investment & savings promotions", "Financial awareness campaigns"], results: ["Qualified financial leads", "Higher approval conversions", "Strong ROI campaigns"], link: null, linkText: "" },
          { emoji: "👗", title: "Fashion Email Marketing Sri Lanka – Grow Your Brand & Sales", campaigns: ["New collection launches", "Seasonal fashion campaigns", "Exclusive offers & influencer collaborations"], results: ["Increased brand awareness", "Higher sales (online & in-store)", "Repeat customers"], link: null, linkText: "" },
          { emoji: "🎉", title: "Event Email Marketing Sri Lanka – Maximize Attendance & Ticket Sales", campaigns: ["Concerts, exhibitions & corporate events", "Early-bird ticket promotions", "Reminder & urgency campaigns"], results: ["Higher event turnout", "Faster ticket sales", "Strong audience engagement"], link: null, linkText: "" },
          ...
          { emoji: "🧳", title: "Travel & Tourism Email Marketing Sri Lanka – Promote Packages & Experiences", campaigns: ["Local & international tour packages", "Holiday & seasonal travel deals", "Group & corporate travel promotions"], results: ["Increased bookings", "More inquiries", "Higher campaign ROI"], link: null, linkText: "" },
        ]}
