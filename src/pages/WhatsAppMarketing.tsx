    ...
    >
      ...
      <IndustryMarketingSection
        ...
        industries={[
          ...
          { emoji: "🛍️", title: "E-commerce WhatsApp Marketing Sri Lanka – Turn Chats into Sales", campaigns: ["Product catalog sharing", "Order placement via WhatsApp", "Abandoned cart recovery messages"], results: ["Higher conversion rates", "Faster purchase decisions", "Increased repeat customers"], link: "/restaurant-marketing-sri-lanka", linkText: "restaurant & retail marketing" },
          { emoji: "🍽️", title: "Restaurant WhatsApp Marketing Sri Lanka – Increase Orders", campaigns: ["Menu sharing & promotions", "Table reservations via chat", "Daily offers & deals"], results: ["More direct orders", "Increased customer engagement", "Higher repeat visits"], link: "/restaurant-marketing-sri-lanka", linkText: "restaurant marketing" },
          { emoji: "💼", title: "Recruitment WhatsApp Marketing Sri Lanka – Hire Faster", campaigns: ["Job alerts via WhatsApp", "Candidate screening chats", "Interview scheduling"], results: ["Faster hiring process", "Higher response rates", "Better candidate engagement"], link: "/staff-recruitment-campaigns-sri-lanka", linkText: "staff recruitment" },
          ...
          { emoji: "🏦", title: "Finance & Insurance WhatsApp Marketing – Generate Leads", campaigns: ["Loan & leasing inquiries", "Instant eligibility checks", "Financial consultation chats"], results: ["High-quality leads", "Faster decision-making", "Increased conversions"], link: "/finance-marketing-sri-lanka", linkText: "finance marketing" },
          { emoji: "👗", title: "Fashion & Clothing WhatsApp Marketing – Sell Directly", campaigns: ["Product catalogs & collections", "Order via WhatsApp chat", "VIP customer offers"], results: ["Direct sales through chat", "Higher engagement", "Repeat purchases"], link: "/fashion-marketing-sri-lanka", linkText: "fashion marketing" },
          { emoji: "🎉", title: "Event WhatsApp Marketing Sri Lanka – Maximize Attendance", campaigns: ["Event promotions & updates", "Ticket booking links", "Reminder notifications"], results: ["Higher attendance rates", "Better engagement", "Faster ticket sales"], link: "/event-marketing-sri-lanka", linkText: "event marketing" },
          ...
          { emoji: "🧳", title: "Travel & Tourism WhatsApp Marketing – Increase Bookings", campaigns: ["Tour package promotions", "Travel inquiries handled instantly", "Booking confirmations"], results: ["Increased travel bookings", "Faster responses", "Higher customer satisfaction"], link: "/hotel-marketing-sri-lanka", linkText: "hotel & travel marketing" },
        ]}
