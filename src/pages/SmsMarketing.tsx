  ...
  return (
    ...
    >
      ...
      <IndustryMarketingSection
        sectionEmoji="📱"
        sectionTitle="SMS Marketing Services for Every Industry in Sri Lanka"
        intro="Looking for SMS marketing in Sri Lanka that delivers instant results? With open rates as high as 98%, SMS is one of the fastest and most effective ways to reach customers and drive immediate action."
        subtitle="Our targeted SMS campaigns help businesses across Sri Lanka generate leads, increase sales, and engage customers in real time."
        industries={[
          { emoji: "🏨", title: "Hotel SMS Marketing Sri Lanka – Fill Rooms Fast", campaigns: ["Last-minute room deals & weekend offers", "Seasonal promotions (Avurudu, holidays)", "Booking confirmations & reminders"], results: ["Instant bookings", "Higher occupancy rates", "Reduced unsold inventory"], link: "/hotel-marketing-sri-lanka", linkText: "hotel marketing" },
          { emoji: "🎓", title: "Education SMS Marketing Sri Lanka – Drive Student Inquiries", campaigns: ["Course intake alerts", "Deadline reminders for registration", "Open day / seminar invitations"], results: ["Immediate student inquiries", "Faster enrollment decisions", "Higher response rates than email"], link: "/education-marketing-sri-lanka", linkText: "education marketing" },
          { emoji: "🏠", title: "Real Estate SMS Marketing Sri Lanka – Generate Property Leads", campaigns: ["Property launch alerts", "Price drop & limited-unit promotions", "Site visit invitations"], results: ["Direct buyer inquiries", "Faster conversions", "High-intent leads"], link: "/real-estate-marketing-sri-lanka", linkText: "real estate marketing" },
          { emoji: "🛍️", title: "Retail & E-commerce SMS Marketing – Boost Sales Instantly", campaigns: ["Flash sales & limited-time discounts", "Promo codes & exclusive offers", "Abandoned cart reminders"], results: ["Immediate purchases", "Higher conversion rates", "Increased repeat customers"], link: null, linkText: "" },
          { emoji: "🛍️", title: "Retail & E-commerce SMS Marketing – Boost Sales Instantly", campaigns: ["Flash sales & limited-time discounts", "Promo codes & exclusive offers", "Abandoned cart reminders"], results: ["Immediate purchases", "Higher conversion rates", "Increased repeat customers"], link: "/restaurant-marketing-sri-lanka", linkText: "restaurant & retail marketing" },
          { emoji: "🍽️", title: "Restaurant SMS Marketing Sri Lanka – Increase Daily Orders", campaigns: ["Lunch / dinner deals", "Daily specials & promotions", "Reservation confirmations"], results: ["Increased foot traffic", "More repeat customers", "Higher daily revenue"], link: "/restaurant-marketing-sri-lanka", linkText: "restaurant marketing" },
          { emoji: "💼", title: "Recruitment SMS Marketing Sri Lanka – Hire Faster", campaigns: ["Job vacancy alerts", "Interview reminders", "Bulk hiring campaigns"], results: ["Faster applicant response", "More qualified candidates", "Reduced hiring time"], link: "/staff-recruitment-campaigns-sri-lanka", linkText: "staff recruitment" },
          { emoji: "🏥", title: "Healthcare SMS Marketing Sri Lanka – Improve Patient Engagement", campaigns: ["Appointment reminders", "Health check promotions", "Follow-up messages"], results: ["Reduced no-shows", "Increased bookings", "Better patient retention"], link: null, linkText: "" },
          { emoji: "🚗", title: "Automotive SMS Marketing Sri Lanka – Increase Inquiries", campaigns: ["Vehicle offers & promotions", "Service reminders", "New model launches"], results: ["More showroom visits", "Increased inquiries", "Better customer retention"], link: null, linkText: "" },
          { emoji: "🏦", title: "Finance & Insurance SMS Marketing – Generate Leads", campaigns: ["Loan & leasing offers", "Payment reminders", "Investment promotions"], results: ["High-quality leads", "Faster decision-making", "Strong ROI"], link: "/finance-marketing-sri-lanka", linkText: "finance marketing" },
          { emoji: "👗", title: "Fashion & Clothing SMS Marketing – Drive Sales", campaigns: ["New arrivals & collections", "Seasonal discounts", "Exclusive VIP offers"], results: ["Increased store visits", "Higher sales", "Strong brand recall"], link: "/fashion-marketing-sri-lanka", linkText: "fashion marketing" },
          { emoji: "🎉", title: "Event SMS Marketing Sri Lanka – Maximize Attendance", campaigns: ["Event announcements", "Ticket promotions", "Reminder alerts"], results: ["Higher attendance rates", "Faster ticket sales", "Better engagement"], link: "/event-marketing-sri-lanka", linkText: "event marketing" },
          { emoji: "🏢", title: "Corporate & B2B SMS Marketing – Reach Decision Makers", campaigns: ["Business offers & promotions", "Service announcements", "Partnership campaigns"], results: ["Direct reach to professionals", "Higher B2B conversions", "Faster responses"], link: null, linkText: "" },
          { emoji: "🧳", title: "Travel & Tourism SMS Marketing – Promote Packages", campaigns: ["Tour deals & holiday packages", "Last-minute travel offers", "Booking confirmations"], results: ["Increased bookings", "Faster inquiries", "Higher campaign ROI"], link: "/hotel-marketing-sri-lanka", linkText: "hotel & travel marketing" },
        ]}
        whyTitle="🔥 Why SMS Marketing Works So Well in Sri Lanka"
        whyPoints={["Messages are delivered instantly to mobile users", "Extremely high open rates (near 98%)", "Perfect for urgent promotions & reminders", "Cost-effective compared to traditional advertising", "Works across all industries"]}
        whyFooter="👉 With high mobile usage in Sri Lanka, SMS marketing is one of the most direct ways to reach customers"
        crossLinks={[{ to: "/email-marketing", label: "Email marketing" }, { to: "/whatsapp-marketing", label: "WhatsApp marketing" }]}
        ctaTitle="🚀 Start Your SMS Marketing Campaign in Sri Lanka Today"
        ctaSubtitle="Ready to reach thousands of customers instantly?"
        ctaWhatsAppMessage="Hi Buzz Connect, I want to start an SMS marketing campaign for my industry."
        ctaButtonText="Get a Free Consultation & Targeting Plan"
      />
