        ...
        >
          ...
          <div className="p-6 rounded-2xl bg-card shadow-card border border-border">
            <p className="text-muted-foreground leading-relaxed mb-3">
              One of the biggest advantages of <Link to="/email-marketing" className="text-accent hover:underline font-semibold">email marketing in Sri Lanka</Link> is its versatility. Whether you're running a university, managing hotel bookings, selling real estate properties, or promoting a restaurant, email marketing can be tailored to your specific industry needs.
            </p>
