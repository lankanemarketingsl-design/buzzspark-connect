...
const comboPackages = [
  ...
  },
  {
    ...
    impressions: "750,000",
    period: "4 Days",
    desc: "For those who are large enterprise, increase brand awareness and brand recognition, with featured Ads and website banners for the most demanded website for offers, discounts, and promotions. Provide effective desc: "For those who are large enterprise, increase brand awareness and brand recognition, with featured Ads and website banners for the most demanded website for offers, discounts, and promotions. Provide effective email campaigns for 350,000 subscribers.",.",
...
const faqs = [
  ...
  { q: "How much does advertising in Sri Lanka cost?", a: "Advertising in Sri Lanka varies by channel. { q: "How much does advertising in Sri Lanka cost?", a: "Advertising in Sri Lanka varies by channel. Banner ads start from LKR 5,000, email campaigns from LKR 4,000, and multi-channel combo packages from LKR 10,000. BuzzConnect offers flexible pricing for every budget." },, and multi-channel combo packages from LKR 10,000. BuzzConnect offers flexible pricing for every budget." },
